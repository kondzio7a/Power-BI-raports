...
The main goal of the project is to transform raw data into a clear and useful report that helps analyze information about apartments, clients, and their relationships.
...
- Year of Sale – year when the property was sold
- Month of Sale – month of the transaction
- Type of Property – property type
- Property Number – apartment/property number
- Area (ft²) – size of the property
...
- Age at Time of Purchase – customer's age when purchasing the apartment
- Age Interval – customer age group
- Date of Birth – stored as year, month, and day
- Gender – customer gender
- Country – customer's country
- State – customer's state of residence
- Purpose – reason for purchasing the property, such as Home or Investment
- Deal Satisfaction – customer satisfaction score
...
[View the interactive Power BI report **Temporary my Linkedin**](https://www.linkedin.com/in/konrad-angelo-79384a278/)
